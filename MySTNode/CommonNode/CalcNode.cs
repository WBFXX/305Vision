...
namespace _305Vision
{
    ...
    /// </summary>
    [STNode("/", "DebugST", "1157712386@qq.com", "C305.com", "测试专用,并不包含功能.")]
    ...
    public class CalcNode : STNode
    {
        ...
        private StringFormat m_b;
        private StringFormat m_c;

        [STNodeProperty("Name", "测试啊")]
        public StringFormat B { get => m_b; set => m_b = value; }
        [STNodeProperty("quet", "测试sss")]
        public StringFormat C { get => m_c; set => m_c = value; }
        ...
        protected override void OnCreate()
        {
            ...
            this.OutputOptions.Add("结果", typeof(int), false);
        }
