...
namespace _305Vision.Blender
{
    ...
    /// 此类仅仅是演示 并不包含颜色混合功能
    /// </summary>
    [STNode("/Blender(测试)/", "Crystal_lz", "2212233137@qq.com", "st233.com", "this is blender mixrgb node")]
    public class BlenderMixColorNode : STNode
    {
        ...
        [STNodeProperty("Color1", "This is color1", DescriptorType = typeof(_305Vision.DescriptorForColor))]
        public Color Color1 {
            get { return _Color1; }
        ...
        [STNodeProperty("Color2", "This is color2", DescriptorType = typeof(_305Vision.DescriptorForColor))]
        public Color Color2 {
            get { return _Color2; }
